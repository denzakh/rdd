...
export const ru = {
  ...
  landing: {
    ...
    cardPassportText:
      'Интерфейс для заполнения социально-демографического профиля. Включает анонимизироваые личные данные и управление согласием на исследование. Автоматически рассчитывает некоторые параметры, например, возраст манифеста заболевания.',
