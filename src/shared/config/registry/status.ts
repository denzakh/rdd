export const MENTAL_STATUS_REGISTRY = {
  ...
  appetite_loss: {
    id: 'appetite_loss',
    label: 'Снижение аппетита',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  cognitive_impair: {
    id: 'cognitive_impair',
    label: 'Ухудшение сообразительности/памяти',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  physical_pain: {
    id: 'physical_pain',
    label: 'Боли различной локализации',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  ...
  fixed_posture: {
    id: 'fixed_posture',
    label: 'Однообразная поза',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  mimic_poverty: {
    id: 'mimic_poverty',
    label: 'Бедность мимики',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  monotonous_voice: {
    id: 'monotonous_voice',
    label: 'Тихий монотонный голос',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  motor_retardation: {
    id: 'motor_retardation',
    label: 'Замедление движений, заторможенность',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  delayed_response: {
    id: 'delayed_response',
    label: 'Ответ после паузы',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  restlessness: {
    id: 'restlessness',
    label: 'Неусидчивость, суетливость',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  affect_lability: {
  ...
  motor_agitation: {
    id: 'motor_agitation',
    label: 'Двигательное беспокойство',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  hygiene_decline: {
    id: 'hygiene_decline',
    label: 'Снижение гигиены, неопрятность',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  ...
  hallucinations: {
    id: 'hallucinations',
    label: 'Галлюцинаторные расстройства',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  delusions: {
  ...
  obsessions: {
    id: 'obsessions',
    label: 'Обсессивные/компульсивные симптомы',
    ui: 'checkbox',
    db_type: 'BOOLEAN',
  },
  insight: {
