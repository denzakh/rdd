 ...
 * (инъекция невозможна); вывод о динамике (порог 5%, см. statistics-panel.tsx):
 * ratio > 1.05 — укорочение (для фаз хорошо, для интермиссий плохо),
 * ratio < 0.95 — удлинение (для фаз плохо, для интермиссий хорошо).
 */
