export const REMISSION_REGISTRY = {
  ...
  subdepression_const: {
    ...
    label: { ru: "Постоянная субдепрессия", en: "Persistent Subdepression" },
    ui: "checkbox",
    db_type: "BOOLEAN",
  ...
  unfavorable_env: {
    id: "unfavorable_env",
    label: { ru: "Неблагоприятная обстановка", en: "Unfavorable Environment" },
    ui: "checkbox",
    db_type: "BOOLEAN",
    scope: "phase"
  },
  ...
  pure_remission: {
    ...
    calculate: (data) => {
      const sum = Number(data.subdepression_const) + 
