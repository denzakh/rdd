...
Это не пересказ спецификаций: каждый раздел — самая показательная развилка «проблема →
рассмотренные варианты → решение» со ссылкой на первоисточник, где лежит полный разбор
с порогами эскалации.
