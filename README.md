...
Веб-приложение клинического регистра: паспорт пациента, матрица фаз заболевания
(фармакотерапия, ремиссия, психический статус, шкалы), роли, аудит и аутентификация.
...
- `docs/roadmap.md` — план этапов (спеки `spec-stage-1..4.md`)
